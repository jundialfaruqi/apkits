    ...
    @else
        <div class="page-body">
            <div class="container-fluid">
                <div class="row row-deck row-cards mb-5 justify-content-center">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="text-secondary">
                                            {{ $totalRancangansMounth }} Kegiatan bulan ini
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-12 col-xl-7">
                        ...
                        @if ($rancangans->isEmpty())
                            <div class="container-fluid text-center" style="margin-top: 98px; margin-bottom: 98px">
                                <div class="text-center">
                                    ...
                                    <p class="text-secondary">Oppss, Belum ada kegiatan hari ini</p>
                                </div>
                            </div>
                        @else
